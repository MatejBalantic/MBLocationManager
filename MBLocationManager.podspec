#
#  Be sure to run `pod spec lint MBLocationManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.1.0"
  s.summary      = "A short description of MBLocationManager."
  ...
  # s.authors          = { "Matej Balantič" => "matej.balantic@pop-tv.si", "other author" => "email@address.com" }
  # s.author           = 'Matej Balantič', 'other author'
